    ...
    ?>
		...
		<div class="main-banner">            
			<div class="video-container<?php if (get_field('_mobileBg_main')) echo ' withmobileimage'; ?>">
				<video autoplay loop id="video" <?php /* poster="<?php if ($poster = get_field('_main_banner_image')) echo $poster; ?>"*/ ?> muted plays-inline>
		...
		<?php } ?>
			...
			<div class="banner-text">
				<?php the_content(); ?>
				<div class="search">
					<a class="btn btn-white" target="_blank" href="<?php echo the_field('_search_jobs_link', 'option'); ?>">Search jobs</a>                    
				</div>
