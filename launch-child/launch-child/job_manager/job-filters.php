...
<form class="job_filters">
	...
	<div class="search_jobs">
		...
		<div class="search_keywords">
			...
			<input type="text" name="search_keywords" id="search_keywords" placeholder="<?php esc_attr_e( 'Keywords', 'wp-job-manager' ); ?>" value="<?php echo esc_attr( $keywords ); ?>" class="form-control" />
		</div>

		<div class="search_location" style="position:relative">
			<label for="search_location"><?php esc_html_e( 'Location', 'wp-job-manager' ); ?></label>
			<!-- <input type="text" name="search_location" id="search_location" placeholder="<?php esc_attr_e( 'Location', 'wp-job-manager' ); ?>" value="<?php echo esc_attr( $location ); ?>" class="form-control" /> -->
			 <select id="search_location" name="search_location" class="defaultSelect" id="search_location" placeholder="<?php esc_attr_e( 'Location', 'wp-job-manager' ); ?>" value="<?php echo esc_attr( $location ); ?>">
...
<option>Perth</option>
		...
		?>
			<div class="search_submit">
				<input type="submit" value="<?php esc_attr_e( 'Search Jobs', 'wp-job-manager' ); ?>" class="btn btn-red">
			</div>
		<?php endif; ?>
...
<!-- <script>
        jQuery(document).ready(function() {
            jQuery('#search_location').select2();
        });
